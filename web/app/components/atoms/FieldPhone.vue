...
function onInput(e: Event) {
  ...
  model.value = plus + raw.replace(/[^0-9\s]/g, '')
}
</script>

<template>
  <div
    class="app-atoms-field-phone"
    :class="{
      'app-atoms-field-phone--focused': focused,
      'app-atoms-field-phone--filled': hasValue,
  ...
  >
    <label
      :for="inputId"
      class="app-atoms-field-phone__label"
    ...
    <input
      ...
      ref="inputRef"
      :value="model"
      class="app-atoms-field-phone__input P1 regular-text"
      type="tel"
      inputmode="tel"
      autocomplete="tel"
      :required="required"
    ...
    <TextsP2
      ...
      tag="span"
      color="red"
      class="app-atoms-field-phone__error"
    >
      {{ errorMessage }}
    </TextsP2>
  </div>
